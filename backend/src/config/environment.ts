...
function validateNodeEnv(value: string | undefined): EnvironmentConfig['nodeEnv'] {
  const validEnvs: EnvironmentConfig['nodeEnv'][] = ['development', 'test', 'production'];
...
function validateLogLevel(value: string | undefined): EnvironmentConfig['logLevel'] {
  const validLevels: EnvironmentConfig['logLevel'][] = ['error', 'warn', 'info', 'debug'];
